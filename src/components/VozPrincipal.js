...
import {faArrowRight, facircleuser, faUserCircle, faRocket, faBullhorn, faBullseyeArrow, faCommentCheck, faHeadset } from "@fortawesome/pro-light-svg-icons";
...
const VozPrincipal = () => (
  ...
  <div className="flex flex-col margin-sidebar margin-contenido">
    ...
    <h3 style={{fontSize:"36px", fontWeight:"700", color:"#5D2766" }} className="mb-3">Nuestro Tono de Voz</h3>
    ...
    <div style={{ gridTemplateColumns: "1fr 1fr", gap: "5vh"}} className="grid">
        ...
        <div className="icon-box background-primary text-color-grayscale-7"> <FontAwesomeIcon icon={faCommentCheck} /></div>
        <div style={{fontWeight: "700", color: "#525A6C", fontSize: "20px"}}>Voz</div>
        <div>En Xtrim definimos nuestra identidad como la base de nuestra comunicación, somos sociables, realistas y optimistas.</div>
      </div>
       <div className="flex flex-col icon-card gap-2">
        <div className="icon-box background-primary text-color-grayscale-7"> <FontAwesomeIcon icon={faHeadset} /></div>
    ...
    <div className="flex flex-col gap-2" >
    <div style={{fontSize:"31px", color:"#222D44", fontWeight:"500"}}><p>¿Qué es nuestra Voz?</p></div>
    ...
    <div className="flex flex-col gap-2" >
    <div style={{fontSize:"31px", color:"#222D44", fontWeight:"500"}}><p>¿Qué es nuestro Tono?</p></div>
    ...
    <div className="flex flex-col gap-2" >
    <div style={{fontSize:"31px", color:"#222D44", fontWeight:"500"}}><p>¿Por qué establecemos nuestro Tono de voz?</p></div>
    ...
    <div className="flex flex-col gap-2" >
    <div style={{fontSize:"31px", color:"#222D44", fontWeight:"500"}}><p>Principios de Voz y Tono</p></div>
